...
ZSH_THEME_FONT_NAME="JetBrainsMono Nerd Font"
...
alias lg="lazygit"
alias ll="ls -L1hlaF"
alias tt="tree -hF -L 2"
alias ts="tree -hFD -L 1"
alias sau="sudo apt update && sudo apt upgrade -y"

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/addy/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
